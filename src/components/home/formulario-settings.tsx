      ...
      <>
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <ScrollArea className="flex-1 min-w-0">
            <div className="p-6">
              {activeSection === "info" && !formulario.editable && (
                <InfoSection formulario={formulario} />
              )}
  ...
  return (
    <div className="flex gap-2 items-center">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  className="size-7 md:size-8 relative p-0 flex items-center justify-center shrink-0"
                >
        ...
        <DialogContent
          className="h-[80vh] flex flex-col p-0 gap-0 md:max-w-4xl"
