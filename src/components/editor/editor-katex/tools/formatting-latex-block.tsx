...
const GREEK_LETTERS = [
    { value: "alfa", label: "Alfa", snippet: String.raw`\alpha $0`, preview: String.raw`\alpha ` },
    { value: "beta", label: "Beta", snippet: String.raw`\beta $0`, preview: String.raw`\beta ` },
    { value: "gamma", label: "Gamma", snippet: String.raw`\gamma $0`, preview: String.raw`\gamma ` },
    { value: "gamma_maiuscola", label: "Gamma maiuscola", snippet: String.raw`\Gamma $0`, preview: String.raw`\Gamma ` },
    { value: "delta", label: "Delta", snippet: String.raw`\delta $0`, preview: String.raw`\delta ` },
    { value: "delta_maiuscola", label: "Delta maiuscola", snippet: String.raw`\Delta $0`, preview: String.raw`\Delta ` },
    { value: "epsilon", label: "Epsilon", snippet: String.raw`\varepsilon $0`, preview: String.raw`\varepsilon ` },
    { value: "zeta", label: "Zeta", snippet: String.raw`\zeta $0`, preview: String.raw`\zeta ` },
    { value: "eta", label: "Eta", snippet: String.raw`\eta $0`, preview: String.raw`\eta ` },
    { value: "teta", label: "Teta", snippet: String.raw`\theta $0`, preview: String.raw`\theta ` },
    { value: "teta_maiuscola", label: "Teta maiuscola", snippet: String.raw`\Theta $0`, preview: String.raw`\Theta ` },
    { value: "lambda", label: "Lambda", snippet: String.raw`\lambda $0`, preview: String.raw`\lambda ` },
    { value: "mu", label: "Mu", snippet: String.raw`\mu $0`, preview: String.raw`\mu ` },
    { value: "nu", label: "Nu", snippet: String.raw`\nu $0`, preview: String.raw`\nu ` },
    { value: "xi", label: "Xi", snippet: String.raw`\xi $0`, preview: String.raw`\xi ` },
    { value: "pi", label: "Pi greco", snippet: String.raw`\pi $0`, preview: String.raw`\pi ` },
    { value: "rho", label: "Rho", snippet: String.raw`\rho $0`, preview: String.raw`\rho ` },
    { value: "sigma", label: "Sigma", snippet: String.raw`\sigma $0`, preview: String.raw`\sigma ` },
    { value: "sigma_maiuscola", label: "Sigma maiuscola", snippet: String.raw`\Sigma $0`, preview: String.raw`\Sigma ` },
    { value: "tau", label: "Tau", snippet: String.raw`\tau $0`, preview: String.raw`\tau ` },
    { value: "phi", label: "Phi", snippet: String.raw`\varphi $0`, preview: String.raw`\varphi ` },
    { value: "phi_maiuscola", label: "Phi maiuscola", snippet: String.raw`\Phi $0`, preview: String.raw`\Phi ` },
    { value: "chi", label: "Chi", snippet: String.raw`\chi $0`, preview: String.raw`\chi ` },
    { value: "psi", label: "Psi", snippet: String.raw`\psi $0`, preview: String.raw`\psi ` },
    { value: "omega", label: "Omega", snippet: String.raw`\omega $0`, preview: String.raw`\omega ` },
    { value: "omega_maiuscola", label: "Omega maiuscola", snippet: String.raw`\Omega $0`, preview: String.raw`\Omega ` },
].sort((a, b) => a.label.localeCompare(b.label));

const LOGIC_SYMBOLS = [
    { value: "per_ogni", label: "Per ogni", snippet: String.raw`\forall $0`, preview: String.raw`\forall ` },
    { value: "esiste", label: "Esiste", snippet: String.raw`\exists $0`, preview: String.raw`\exists ` },
    { value: "non_esiste", label: "Non esiste", snippet: String.raw`\nexists $0`, preview: String.raw`\nexists ` },
    { value: "appartiene", label: "Appartiene", snippet: String.raw`\in $0`, preview: String.raw`\in ` },
    { value: "non_appartiene", label: "Non appartiene", snippet: String.raw`\notin $0`, preview: String.raw`\notin ` },
    { value: "sottoinsieme", label: "Sottoinsieme", snippet: String.raw`\subset $0`, preview: String.raw`\subset ` },
    { value: "sottoinsieme_uguale", label: "Sottoinsieme o uguale", snippet: String.raw`\subseteq $0`, preview: String.raw`\subseteq ` },
    { value: "unione", label: "Unione", snippet: String.raw`\cup $0`, preview: String.raw`\cup ` },
    { value: "intersezione", label: "Intersezione", snippet: String.raw`\cap $0`, preview: String.raw`\cap ` },
    { value: "insieme_vuoto", label: "Insieme vuoto", snippet: String.raw`\emptyset $0`, preview: String.raw`\emptyset ` },
    { value: "e_logico", label: "E logico", snippet: String.raw`\land $0`, preview: String.raw`\land ` },
...
const RELATION_SYMBOLS = [
    { value: "diverso", label: "Diverso", snippet: String.raw`\neq $0`, preview: String.raw`\neq ` },
    { value: "minore_uguale", label: "Minore o uguale", snippet: String.raw`\leq $0`, preview: String.raw`\leq ` },
    { value: "maggiore_uguale", label: "Maggiore o uguale", snippet: String.raw`\geq $0`, preview: String.raw`\geq ` },
    { value: "molto_minore", label: "Molto minore", snippet: String.raw`\ll $0`, preview: String.raw`\ll ` },
    { value: "molto_maggiore", label: "Molto maggiore", snippet: String.raw`\gg $0`, preview: String.raw`\gg ` },
    { value: "circa_uguale", label: "Circa uguale", snippet: String.raw`\approx $0`, preview: String.raw`\approx ` },
    { value: "simile", label: "Simile", snippet: String.raw`\sim $0`, preview: String.raw`\sim ` },
    { value: "simile_uguale", label: "Simile o uguale", snippet: String.raw`\simeq $0`, preview: String.raw`\simeq ` },
    { value: "proporzionale", label: "Proporzionale", snippet: String.raw`\propto $0`, preview: String.raw`\propto ` },
    { value: "piu_meno", label: "Più o meno", snippet: String.raw`\pm $0`, preview: String.raw`\pm ` },
    { value: "prodotto_cartesiano", label: "Prodotto cartesiano", snippet: String.raw`\times $0`, preview: String.raw`\times ` },
    { value: "prodotto_scalare", label: "Prodotto scalare", snippet: String.raw`\cdot $0`, preview: String.raw`\cdot ` },
    { value: "infinito", label: "Infinito", snippet: String.raw`\infty $0`, preview: String.raw`\infty ` },
].sort((a, b) => a.label.localeCompare(b.label));

const ARROW_SYMBOLS = [
    { value: "freccia_destra", label: "Freccia destra", snippet: String.raw`\to $0`, preview: String.raw`\to ` },
    { value: "freccia_sinistra", label: "Freccia sinistra", snippet: String.raw`\leftarrow $0`, preview: String.raw`\leftarrow ` },
    { value: "freccia_doppia", label: "Freccia doppia", snippet: String.raw`\leftrightarrow $0`, preview: String.raw`\leftrightarrow ` },
    { value: "implica", label: "Implica", snippet: String.raw`\Rightarrow $0`, preview: String.raw`\Rightarrow ` },
    { value: "implica_sinistra", label: "Implica sinistra", snippet: String.raw`\Leftarrow $0`, preview: String.raw`\Leftarrow ` },
    { value: "se_e_solo_se", label: "Se e solo se", snippet: String.raw`\Leftrightarrow $0`, preview: String.raw`\Leftrightarrow ` },
    { value: "mappa_a", label: "Mappa a", snippet: String.raw`\mapsto $0`, preview: String.raw`\mapsto ` },
    { value: "freccia_su", label: "Freccia su", snippet: String.raw`\uparrow $0`, preview: String.raw`\uparrow ` },
    { value: "freccia_giu", label: "Freccia giù", snippet: String.raw`\downarrow $0`, preview: String.raw`\downarrow ` },
    { value: "freccia_diagonale", label: "Freccia diagonale", snippet: String.raw`\nearrow $0`, preview: String.raw`\nearrow ` },
].sort((a, b) => a.label.localeCompare(b.label));
