          ...
          {!argomento.titolo && argomento.editable && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>
                    Per aggiungere un titolo, inizia la prima riga con{" "}
                    <code>#</code>
                  </p>
                </TooltipContent>
              </Tooltip>
            ...
            <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
              <DialogContent className="sm:max-w-md">
                ...
                <DialogDescription>
                  ...
                  {argomento.titolo || "Senza titolo"}"? Questa azione non è
                  reversibile.
                </DialogDescription>
                <DialogFooter>
                  <DialogClose asChild>
