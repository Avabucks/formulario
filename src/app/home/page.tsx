...
export default async function Home() {
    ...
    const { rows: formulari } = await pool.query(`
        SELECT F.beautiful_id AS "id", titolo, owner_uid AS "ownerUid", U_A.display_name AS "nomeAutore", F.data_creazione as "dataCreazione", descrizione, visibility, views,
