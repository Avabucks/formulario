      ...
      <div className="flex flex-col gap-4 w-full px-2 md:px-6 pt-16">
        <div className="max-w-3xl mx-auto w-full py-8 flex flex-col gap-8">
          ...
          <Section title="2. Dati raccolti">
            <p>
              In fase di creazione dell'account raccogliamo esclusivamente i
              seguenti dati personali forniti tramite il provider di
              autenticazione:
            </p>
            <ul className="list-disc list-inside flex flex-col gap-1 mt-2 text-muted-foreground">
              ...
              <li>
                ...
                : utilizzato esclusivamente internamente, non visibile ad altri
                utenti
              </li>
            </ul>
            <p className="mt-3">
              Non raccogliamo dati sensibili, dati di pagamento, né effettuiamo
              profilazione a fini pubblicitari o commerciali.
            </p>
          </Section>

          <Section title="3. Finalità e base giuridica">
            <p>
              I dati raccolti vengono trattati esclusivamente per la seguente
              finalità:
            </p>
            <ul className="list-disc list-inside flex flex-col gap-1 mt-2 text-muted-foreground">
              <li>
                ...
                : necessaria per l'erogazione del servizio (art. 6, par. 1,
                lett. b GDPR)
              </li>
            </ul>
            <p className="mt-3">
              Non trattiamo i tuoi dati per finalità diverse da quelle indicate,
              né li cediamo a terzi per scopi commerciali.
            </p>
          </Section>

          <Section title="4. Servizi di intelligenza artificiale">
            <p>
              La piattaforma integra <strong>Groq</strong> (con modello{" "}
              <strong>Llama 3.3 70B</strong>) come servizio di intelligenza
              artificiale per la generazione di contenuti. Quando utilizzi
              questa funzionalità:
            </p>
            <ul className="list-disc list-inside flex flex-col gap-1 mt-2 text-muted-foreground">
              <li>
                Solo il testo del prompt che scrivi esplicitamente nell'apposito
                campo viene trasmesso alle API di Groq
              </li>
              <li>
                Il testo dell'argomento su cui stai lavorando viene inviato come
                contesto per migliorare la qualità delle risposte
              </li>
              <li>
                Non inviamo dati personali identificativi (email, nome) alle API
                di Groq
              </li>
              <li>
                Il trattamento dei dati da parte di Groq è disciplinato dalla{" "}
                <a
            ...
            <p className="mt-3">
              Ti invitiamo a non inserire dati personali nel testo dei prompt
              inviati all'assistente AI.
            </p>
          </Section>

          <Section title="5. Visibilità dei dati">
            <p>
              Solo il <strong>display name</strong> è visibile agli altri utenti
              della piattaforma. L'indirizzo email e l'URL della foto profilo
              sono trattati in modo strettamente riservato e non vengono mai
              resi visibili ad altri utenti.
            </p>
          </Section>

          <Section title="6. Conservazione dei dati">
            <p>
              I dati vengono conservati per tutta la durata dell'account. In
              caso di cancellazione dell'account, i dati personali verranno
              eliminati dai nostri sistemi entro 30 giorni, salvo obblighi di
              legge contrari.
            </p>
          </Section>
