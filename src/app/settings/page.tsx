...
const settingsNav = [
    ...
    { href: "#preferences", label: "Preferenze", icon: Palette },
    { href: "#legal", label: "Termini e privacy", icon: Handshake },
    { href: "#danger", label: "Zona pericolosa", icon: Trash2 },
];
        ...
        <>
            ...
            <div className="mx-auto flex w-full flex-1 flex-col gap-6 px-3 pb-10 mt-16 md:px-6">
                <div className="grid gap-6 lg:grid-cols-[16rem_minmax(0,1fr)]">
                    <aside className="w-full overflow-x-auto lg:sticky lg:top-20 lg:h-fit">
...
function SettingsSection({
    ...
    return (
        <Card id={id} className="scroll-mt-24 rounded-lg">
