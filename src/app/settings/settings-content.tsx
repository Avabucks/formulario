...
const settingsNav = [
    ...
    { id: "preferences", href: "/settings/preferences", label: "Preferenze", icon: Palette },
    { id: "legal", href: "/settings/legal", label: "Termini e privacy", icon: Handshake },
    { id: "danger", href: "/settings/danger", label: "Zona pericolosa", icon: Trash2 },
] as const;
...
export async function SettingsContent({ activeSection }: Readonly<{ activeSection: SettingsSectionId }>) {
                    ...
                    <div className="flex flex-col gap-6">
                        {activeSection === "profile" && (
                            ...
                            >
                                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                                    <div className="flex items-center gap-4">
                                        <Avatar size="lg" className="size-16">
                                            {user.photoURL && <AvatarImage src={user.photoURL} alt="foto profilo" />}
                                ...
                                <div className="grid gap-3 sm:grid-cols-3">
                                    <Stat label="Formulari" value={String(stats[0]?.formulari ?? 0)} />
                                    <Stat label="Pubblici" value={String(stats[0]?.pubblici ?? 0)} />
                                    <Stat label="Visualizzazioni" value={String(stats[0]?.views ?? 0)} />
                                </div>
                            </SettingsSection>
                        )}
                        ...
                        {activeSection === "account" && (
                            ...
                            >
                                ...
                                <InfoRow icon={BookOpen} label="Account creato" value={createdAt} />
                            </SettingsSection>
                        )}
                            ...
                            >
                                <div className="flex flex-col gap-4 rounded-lg border border-destructive/30 bg-destructive/5 p-4 sm:flex-row sm:items-center sm:justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Elimina definitivamente account, formulari e dati personali collegati.
                                        </p>
                                    </div>
...
function LegalLink({
    ...
    return (
        ...
        >
            ...
            <p className="mt-auto text-xs uppercase tracking-wide text-muted-foreground">{meta}</p>
        </Link>
    );
}
